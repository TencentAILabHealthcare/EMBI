...
import data.test_ap_dataset_mlp as module_data
...
def main(config):
    ...
    binding_affinity_dataloader = data_loader.get_ap_dataset()
    ...
    resume = '../Result/checkpoints/MLP-Pre-test/0826_193627/model_best.pth'
