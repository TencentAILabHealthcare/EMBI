...
def main(config):
    ...
    ba_model_resume = "../Result/checkpoints/Epitope-MHC-Debug/0907_143655/model_best.pth"
    ap_model_resume = "../Result/checkpoints/EMBert-Pre-Debug/0826_183701/model_best.pth"
    ...
    test_result_df = pd.DataFrame({
        ...
        'Immu_y_pred': list(y_pred.flatten()),
