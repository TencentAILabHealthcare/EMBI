...
import data.test_ba_EMBert as module_data
...
def main(config):
    ...
    test_result_df.to_csv(join(config.save_dir, config['data_loader']['args']['test_file'].replace(".txt",'_EMBert_result.txt')), index=False)
